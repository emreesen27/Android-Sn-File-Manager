...
Emre ESEN built the Sn File Manager app as an Open Source app. This SERVICE is provided by Emre ESEN
...
are accessible at Sn File Manager unless otherwise defined in this Privacy Policy.
...
The application does not transmit any personal data to external servers. Therefore, its security is
directly tied to the security of your device. As secure as your device is, so is the application.
...
These Services are not directed to persons under the age of 13. I do not knowingly collect
personally identifiable information from children under 13. The application does not collect any
data other than error and analysis reports as stated above.
